...
module Smooch
  ...
  class Base
    ...
    def set_cookie(key, value)
      controller.send(:cookies)[key] = { :value => value, :expires => 2.months.from_now }
    end
    def get_cookie(key)
    ...
    def script(production=true)
      ...
      if production
        ...
        out += "_kms('//doug1izaerwt3.cloudfront.net/7d92062a3ef3ebf6b4816ede964990aee12dea7c.1.js');\n"
      end
